      ...
      <Formbox
        ...
        fields={[
          ...
          },
          {
            ...
            className: [
              "border-2 border-dotted border-gray-300 p-3 rounded-lg bg-gray-50",
            ],
            addButtonText: "+ Add Experience",
            addButtonClassName: [
              "text-blue-600 hover:text-blue-700 font-semibold mt-2",
            ],
...
<Formbox
  ...
  formtitle={[
    { title: "Form-Builder", className: ["text-2xl font-bold text-black"] },
  ]}
  closeFormIcon={true}
  textfield={[
    {
  ...
  buttons={[
    {
      ...
      type: "cancel",
      className: [
        "text-gray-600 border border-gray-300 bg-gray-50 hover:bg-gray-100",
      ],
    },
    {
      name: "Delete",
